...
public network
```
rpm --force -Uvh http://39.107.241.0/cloudplus/kube-tools-v1.14.3-cloudplus.1906.el7.x86_64.rpm
yum install docker (1.13) or yum install docker-ce(18.09)
```
...
**[Note that we also provide kube-tools-v1.14.3-cloudplus.1906.el7.x86_64.deb]**
